...
class AlertManager:
    def __init__(self, config_path: str, output_file: str = None):
        # Loading of the alerting rules from the config file
        ...
        # Configuration of alerting emails
    ...
    # Displaying anomalies in a console and by email depending on severity
    ...
    # Console output for each anomaly
    ...
    # Sending an email alert containing anomaly details
